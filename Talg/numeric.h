...
namespace Talg {
	template<class ForwardRange, class T=typename InputRange::value>
	...
	T inner_product(const InputRag1& lhs, const InputRag2& rhs, T&& value=T()) {
	...
	T inner_product( const InputRag1& lhs, const InputRag2& rhs,
					 BinaryOp1 op1, BinaryOp2 ,T&& value=T()){
